...
/*
const scoreDolphins = (100 + 10 + 10) / 3;
const scoreKoalas = (100 + 10 + 10) / 3;
console.log(scoreDolphins, scoreKoalas);

if (scoreDolphins > scoreKoalas && scoreDolphins >= 100) {
  console.log(`Dolphin Wins!! Score: ${scoreDolphins}.`);
} else if (scoreKoalas > scoreDolphins && scoreKoalas >= 100) {
  console.log(`Koalas Wins!! Score: ${scoreKoalas}.`);
} else if (scoreDolphins === scoreKoalas && scoreDolphins >= 100 && scoreKoalas >= 100) {
  console.log(`Draw!! Dolphins: ${scoreDolphins} | Koalas ${scoreKoalas}`);
} else {
